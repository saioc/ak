		...
		<div class="container">
			<div class="pull-left">
				...
				<ul class="pull-left ml20 mr20">
					...
					<li>
						<a>
							<img class="kuangimg" alt="酷ACG资源网" src="<?php echo THEME_ASSET . '/img/qr/weixin.png'; ?>"></a>
					</li>
				</ul>
				<ul class="pull-left ml20 mr20">
					...
					<li>
						<a>
							<img class="kuangimg" alt="酷ACG资源网" src="<?php echo THEME_ASSET . '/img/qr/alipay.png'; ?>"></a>
					</li>
				</ul>
			</div>
              ...
              <div class="footer-copy">
				&copy;&nbsp;<?php echo tt_copyright_year(); ?>&nbsp;&nbsp;<?php echo ' ' . get_bloginfo('name') . ' All Right Reserved '; ?>
                    ...
                    echo '·&nbsp;<a href="http://www.miitbeian.gov.cn/" rel="link" target="_blank">' . $beian . '</a>';
					 ...
					 <?php echo '·&nbsp;<b style="color: #ff4425;">♥</b>&nbsp;Theme By <a href="https://www.kuacg.com/18494.html" title="Tint-K" rel="link" target="_blank">Tint-K</a> & Design By <a href="https://www.kuacg.com/" title="酷ACG" rel="link" target="_blank">酷ACG.</a>'; ?>
