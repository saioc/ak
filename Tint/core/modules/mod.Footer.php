		...
		<div class="container">
			<div class="pull-left">
				...
				<ul class="pull-left ml20 mr20">
					...
					<li>
						<a>
							<img class="kuangimg" alt="福利窝" src="<?php echo THEME_ASSET . '/img/qr/weixin.png'; ?>"></a>
					</li>
				</ul>
				<ul class="pull-left ml20 mr20">
					...
					<li>
						<a>
							<img class="kuangimg" alt="福利窝" src="<?php echo THEME_ASSET . '/img/qr/alipay.png'; ?>"></a>
					</li>
				</ul>
				<ul class="pull-left ml20 mr20">
					<li class="fs16" style="padding: 0px;">官方支付宝</li>
		...
		<div class="container">
			<div class="copyright">
                ...
                <?php if($qq_group = tt_get_option('tt_site_qq_group')) { ?>
                    <a class="fts-qq" href="<?php echo '//shang.qq.com/wpa/qunwpa?idkey=' . $qq_group; ?>" target="_blank">
              ...
              <div class="footer-copy">
				&copy;&nbsp;<?php echo tt_copyright_year(); ?>&nbsp;&nbsp;<?php echo '<a href="https://fuli.hk" title="福利窝" target="_blank"> ' . get_bloginfo('name') . '</a> All Right Reserved fuli.hk'; ?>
