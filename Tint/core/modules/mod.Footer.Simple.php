...
<footer class="footer simple-footer">
    <div class="foot-copyright">&copy;&nbsp;<?php echo tt_copyright_year(); ?><?php echo ' ' . get_bloginfo('name') . ' All Right Reserved · <b style="color: #ff4425;">♥</b>&nbsp;<a href="https://fuli.hk/" title="' . get_bloginfo('name') . '" rel="link" target="_blank">' . get_bloginfo('name') . '</a> '; ?>
    </div>
</footer>
