...
{
    echo '<iframe src="https://mayiwo.xyz/?url=' . get_field('video_url') . '" id="oplayer" width="100%" height="480px" allowtransparency="true" frameborder="0" scrolling="no" border="0" marginwidth="0" marginheight="0" allowfullscreen="true" style="overflow: hidden;"></iframe> <script>
